...
extern void ficom_test(long double a, int32_t b);

// Test cases for FICOM (compare ST(0) with memory integer)
static const struct {
    long double st0;
    int32_t mem_int;
} test_cases[] = {
...
int main() {
    ...
    printf("Testing FICOM (ST(0) vs memory integer):\n");
    ...
    for (size_t i = 0; i < sizeof(test_cases)/sizeof(test_cases[0]); ++i) {
        ...
        // Call assembly function to perform FICOM
        ficom_test(a, b);
