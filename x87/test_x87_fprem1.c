...
void test_fprem1() {
    printf("Testing FPREM1 instruction\n");
    printf("FPREM1 computes IEEE754-compatible partial remainder\n");
    ...
    for (size_t i = 0; i < sizeof(test_cases)/sizeof(test_cases[0]); i++) {
        ...
        long double result;
        long double expected = remainderl(dividend, divisor);
