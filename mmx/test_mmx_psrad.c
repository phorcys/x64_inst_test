...
int main() {
    ...
    printf("Testing MMX PSRAD instruction\n\n");
    
    // Test 1: mm, mm
    printf("Test 1: PSRAD mm, mm\n");
    __m64 res1 = _mm_sra_pi32(a, b);
    print_mmx(a, "a");
    print_mmx(b, "b");
    ...
    // Test 2: mm, imm8
    printf("Test 2: PSRAD mm, imm8\n");
    __m64 res2 = _mm_srai_pi32(a, 3);
    print_mmx(a, "a");
    print_mmx(res2, "result (shift by 3)");
    printf("\n");
    
    // Test 3: mm, m64
    printf("Test 3: PSRAD mm, m64\n");
    __m64 res3 = _mm_sra_pi32(a, *(__m64*)&mem);
    print_mmx(a, "a");
    printf("mem: [%016lx]\n", mem);
    ...
    __m64 res4 = _mm_sra_pi32(max, shift);
    print_mmx(max, "max");
