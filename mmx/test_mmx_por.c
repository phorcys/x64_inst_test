...
int main() {
    printf("Testing POR (Packed Bitwise OR)\n");
    printf("=============================\n\n");
    ...
    // Test case 1: Basic OR operation
    {
        ...
        printf("Test 1: Basic OR operation\n");
        ...
        printf("Expected: 0x0FFF0FFF0FFF0FFF\n");
        printf("\n");
    }

    // Test case 2: OR with all zeros
    {
        uint64_t a = 0x123456789ABCDEF0;
        uint64_t b = 0x0000000000000000;
        uint64_t result;

        printf("Test 2: OR with all zeros\n");
        print_mmx_hex("Input A", a);
        print_mmx_hex("Input B", b);
    ...
    // Test case 3: OR with all ones
    {
        ...
        printf("Test 3: OR with all ones\n");
        print_mmx_hex("Input A", a);
        print_mmx_hex("Input B", b);
        ...
        print_mmx_hex("Result", result);
        printf("Expected: 0xFFFFFFFFFFFFFFFF\n");
        printf("\n");
    }

    printf("POR tests completed.\n");
    return 0;
}
