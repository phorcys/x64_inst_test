...
void test_paddusw() {
    struct TestCase {
        ...
        {{0x0000, 0x0001, 0x7FFF, 0x8000},
         {0x0000, 0x0001, 0x0001, 0x7FFF},
         {0x0000, 0x0002, 0x8000, 0xFFFF}},  // 基本加法
        {{0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF},
         {0x0001, 0xFFFF, 0x8000, 0x7FFF},
         {0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF}},  // 饱和加法
        {{0x8000, 0x8000, 0x8000, 0x8000},
         {0x7FFF, 0x8000, 0x8001, 0xFFFF},
         {0xFFFF, 0xFFFF, 0xFFFF, 0xFFFF}}   // 边界值测试
    };

    printf("=== Testing PADDUSW instruction ===\n");
