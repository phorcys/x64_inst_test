...
int main() {
    // Test PSUBD with various combinations
    __m64 a, b, c;
    
    // Test case 1: Basic subtraction
    a = _mm_set_pi32(300000, 500000);
    ...
    // Test case 2: Underflow cases
    a = _mm_set_pi32(0x80000000, 0x80000000);
    b = _mm_set_pi32(1, 1);
    c = _m_psubd(a, b);
    ...
    a = _mm_set_pi32(2147483647, -2147483648);
    b = _mm_set_pi32(-2147483648, 2147483647);
    c = _m_psubd(a, b);
