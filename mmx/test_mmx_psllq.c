...
int main() {
    ...
    // Test 1: mm, mm
    printf("Test 1: PSLLQ mm, mm\n");
    __m64 res1 = _mm_sll_si64(a, b);
    print_mmx(a, "a");
    print_mmx(b, "b");
    ...
    // Test 2: mm, imm8
    printf("Test 2: PSLLQ mm, imm8\n");
    __m64 res2 = _mm_slli_si64(a, 3);
    print_mmx(a, "a");
    print_mmx(res2, "result (shift by 3)");
    printf("\n");
    
    // Test 3: mm, m64
    printf("Test 3: PSLLQ mm, m64\n");
    __m64 res3 = _mm_sll_si64(a, *(__m64*)&mem);
    print_mmx(a, "a");
    printf("mem: [%016lx]\n", mem);
    ...
    __m64 res4 = _mm_sll_si64(max, shift);
    print_mmx(max, "max");
