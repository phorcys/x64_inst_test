...
int main() {
    printf("Testing PSUBSW (Packed Subtract Signed Word with Saturation)\n");
    printf("==========================================================\n\n");

    // Test case 1: Normal subtraction
    {
        uint64_t a = 0x0002000300047FFF; // [2, 3, 4, 32767]
    ...
    // Test case 2: Positive overflow (saturate to 32767)
    {
        ...
        uint64_t b = 0x8000800080008000; // [-32768, -32768, -32768, -32768]
        uint64_t result;
