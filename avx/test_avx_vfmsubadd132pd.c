...
static void test_reg_reg_operand() {
    ...
    printf("VFMSUBADD132PD Register-Register Tests Completed\n\n");
}
...
int main() {
    ...
    printf("All VFMSUBADD132PD tests completed. Results are for verification on physical CPU vs box64.\n");
