...
static void test_reg_reg_operand() {
    ...
    printf("vfmsubadd231PS Register-Register Tests Completed\n\n");
}
...
static void test_reg_mem_operand() {
    ...
    printf("vfmsubadd231PS Register-Memory Tests Completed\n\n");
}
...
int main() {
    ...
    printf("vfmsubadd231PS tests completed.\n");
