...
static void test_reg_reg_operand() {
    ...
    printf("VFMSUBADD132PS Register-Register Tests Completed\n\n");
}

int main() {
    printf("==================================\n");
    printf("VFMSUBADD132PS Comprehensive Tests\n");
    printf("==================================\n\n");
    
    test_reg_reg_operand();
    
    printf("All VFMSUBADD132PS tests completed. Results are for verification on physical CPU vs box64.\n");
