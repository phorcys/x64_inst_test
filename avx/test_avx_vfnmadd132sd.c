...
static void test_scalar_reg_reg_operand() {
    ...
    printf("vfnmadd132SD Scalar Register-Register Tests Completed\n\n");
}
...
static void test_scalar_reg_mem_operand() {
    ...
    printf("vfnmadd132SD Scalar Register-Memory Tests Completed\n\n");
}

int main() {
    printf("==================================\n");
    printf("vfnmadd132SD Comprehensive Tests\n");
    printf("==================================\n\n");
    
    test_scalar_reg_reg_operand();
    test_scalar_reg_mem_operand();
    
    printf("vfnmadd132SD normal values tests completed.\n");
