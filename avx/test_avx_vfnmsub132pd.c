...
static void test_reg_reg_operand() {
    ...
    printf("VFNMSUB132PD Register-Register Tests Completed\n\n");
}
...
static void test_reg_mem_operand() {
    for (int t = 0; t < TEST_CASE_COUNT; t++) {
        ...
        // 准备内存操作数
        double b[2] = {cases[t].b[0], cases[t].b[1]};
    ...
    printf("VFNMSUB132PD Register-Memory Tests Completed\n\n");
}
...
int main() {
    ...
    printf("All VFNMSUB132PD tests completed. Results are for verification on physical CPU vs box64.\n");
