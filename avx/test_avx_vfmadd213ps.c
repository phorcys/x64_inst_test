...
// vfmadd213ps指令测试
void test_vfmadd213ps() {
    printf("--- Testing vfmadd213ps (Fused Multiply-Add of Packed Single-Precision Floating-Point Values) ---\n");
    ...
    float spec_b[8] ALIGNED(32) = {1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f};
