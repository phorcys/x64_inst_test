...
static void test_reg_reg_operand() {
    ...
    printf("vfnmadd132PS Register-Register Tests Completed\n\n");
}
...
static void test_reg_mem_operand() {
    ...
    printf("vfnmadd132PS Register-Memory Tests Completed\n\n");
}

int main() {
    printf("===============================\n");
    printf("vfnmadd132PS Comprehensive Tests\n");
    printf("===============================\n\n");
    
    test_reg_reg_operand();
    test_reg_mem_operand();
    
    printf("vfnmadd132PS tests completed.\n");
