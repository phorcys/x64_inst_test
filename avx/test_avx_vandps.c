...
static void test_vandps() {
    printf("--- Testing vandps (packed single-precision bitwise AND) ---\n");
    int total_tests = 0;
    int passed_tests = 0;
    ...
    print_int32_vec("Expected", (int32_t*)expected_u32, 8);
    print_int32_vec("Result", (int32_t*)result_u32, 8);
    ...
    print_int32_vec("Expected", (int32_t*)expected_128_u32, 4);
    print_int32_vec("Result", (int32_t*)result_128_u32, 4);
    ...
    if (passed_tests == total_tests) {
        printf("All vandps tests passed!\n");
    } else {
        printf("Some vandps tests failed\n");
    }
}
