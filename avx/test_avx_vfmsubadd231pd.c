...
// vfmsubadd231pd指令测试
void test_vfmsubadd231pd() {
    printf("--- Testing vfmsubadd231pd (Fused Multiply-Subtract-Add of Packed Double-Precision Floating-Point Values) ---\n");
