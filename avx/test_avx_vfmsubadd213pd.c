...
static void test_reg_reg_operand() {
    ...
    printf("VFMSUBADD213PD Register-Register Tests Completed\n\n");
}
...
int main() {
    ...
    printf("All VFMSUBADD213PD tests completed. Results are for verification on physical CPU vs box64.\n");
