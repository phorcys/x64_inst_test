...
static void test_256bit_reg_reg_operand() {
    ...
    printf("vfmsubadd213PD 256-bit Register-Register Tests Completed\n\n");
}
...
static void test_128bit_reg_reg_operand() {
    ...
    printf("vfmsubadd213PD 128-bit Register-Register Tests Completed\n\n");
}
...
static void test_256bit_reg_mem_operand() {
    ...
    printf("vfmsubadd213PD 256-bit Register-Memory Tests Completed\n\n");
}
...
static void test_128bit_reg_mem_operand() {
    ...
    printf("vfmsubadd213PD 128-bit Register-Memory Tests Completed\n\n");
}

int main() {
    printf("==================================\n");
    printf("vfmsubadd213PD Comprehensive Tests\n");
    printf("==================================\n\n");
    ...
    printf("vfmsubadd213PD normal values tests completed.\n");
