...
// vfnmadd231sd指令测试
void test_vfnmadd231sd() {
    printf("--- Testing vfnmadd231sd (Fused Negative Multiply-Add of Scalar Double-Precision Floating-Point Values) ---\n");
