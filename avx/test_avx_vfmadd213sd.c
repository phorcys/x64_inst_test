...
// vfmadd213sd指令测试
void test_vfmadd213sd() {
    printf("--- Testing vfmadd213sd (Fused Multiply-Add of Scalar Double-Precision Floating-Point Values) ---\n");
    ...
    // 预期结果 (vfmadd213sd: res = c*a + b)
    double expected = c * a + b;
