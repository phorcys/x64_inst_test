...
static void test_256bit_reg_reg_operand() {
    ...
    printf("vfnmadd231PD 256-bit Register-Register Tests Completed\n\n");
}
...
static void test_128bit_reg_reg_operand() {
    ...
    printf("vfnmadd231PD 128-bit Register-Register Tests Completed\n\n");
}
...
static void test_256bit_reg_mem_operand() {
    ...
    printf("vfnmadd231PD 256-bit Register-Memory Tests Completed\n\n");
}
...
static void test_128bit_reg_mem_operand() {
    ...
    printf("vfnmadd231PD 128-bit Register-Memory Tests Completed\n\n");
}
...
int main() {
    ...
    printf("vfnmadd231PD normal values tests completed.\n");
