...
static void test_256bit_reg_reg_operand() {
    ...
    printf("vfmsub132PD 256-bit Register-Register Tests Completed\n\n");
}
...
static void test_128bit_reg_reg_operand() {
    ...
    printf("vfmsub132PD 128-bit Register-Register Tests Completed\n\n");
}
...
static void test_256bit_reg_mem_operand() {
    ...
    printf("vfmsub132PD 256-bit Register-Memory Tests Completed\n\n");
}
...
static void test_128bit_reg_mem_operand() {
    ...
    printf("vfmsub132PD 128-bit Register-Memory Tests Completed\n\n");
}
...
int main() {
    ...
    printf("vfmsub132PD normal values tests completed.\n");
