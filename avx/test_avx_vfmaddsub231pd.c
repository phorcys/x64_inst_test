...
static void test_reg_reg_operand() {
    ...
    printf("VFMADDSUB231PD Register-Register Tests Completed\n\n");
}
...
static void test_reg_mem_operand() {
    ...
    printf("VFMADDSUB231PD Register-Memory Tests Completed\n\n");
}
...
int main() {
    ...
    printf("VFMADDSUB231PD tests completed.\n");
