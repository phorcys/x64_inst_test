...
// VPMAXUD测试函数
int test_vpmaxud() {
    printf("Testing VPMAXUD instruction\n");
    printf("==========================\n");
    ...
    // 测试1: 128位基本功能测试
    {
        ...
        // 测试数据包含边界值和常规值
        uint32_t src1[4] = {4294967295, 0, 1000000000, 2000000000};
        uint32_t src2[4] = {0, 4294967295, 2000000000, 1000000000};
        uint32_t dst[4] = {0};

        // 预期结果
        uint32_t expected[4] = {
            4294967295, 4294967295, 2000000000, 2000000000
        };
    ...
    // 测试2: 128位内存操作数测试
    {
        ...
        // 寄存器操作数
        uint32_t src1[4] = {3000000000, 4000000000, 3500000000, 2500000000};
        
        // 内存操作数
        uint32_t src2_mem[4] = {
            2500000000, 3500000000, 4000000000, 3000000000
        };
        uint32_t dst[4] = {0};

        // 预期结果
        uint32_t expected[4] = {
            3000000000, 4000000000, 4000000000, 3000000000
        };
