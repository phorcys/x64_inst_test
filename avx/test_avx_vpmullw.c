...
// VPMULLW测试函数
int test_vpmullw() {
    printf("Testing VPMULLW instruction\n");
    printf("==========================\n");
    ...
    // 测试4: 256位AVX测试
    {
        ...
        // 初始化测试数据
        int16_t src1[16] = {1000, -2000, 3000, -4000, 5000, -6000, 7000, -8000, 
                            9000, -10000, 11000, -12000, 13000, -14000, 15000, -16000};
        int16_t src2[16] = {-1500, 2500, -3500, 4500, -5500, 6500, -7500, 8500,
