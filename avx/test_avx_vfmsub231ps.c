...
static void test_reg_reg_operand() {
    ...
    printf("VFMSUB231PS Register-Register Tests Completed\n\n");
}

int main() {
    printf("==================================\n");
    printf("VFMSUB231PS Comprehensive Tests\n");
    printf("==================================\n\n");
    
    test_reg_reg_operand();
    
    printf("All VFMSUB231PS tests completed. Results are for verification on physical CPU vs box64.\n");
