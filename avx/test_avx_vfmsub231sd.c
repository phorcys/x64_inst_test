...
static void test_scalar_reg_reg_operand() {
    ...
    printf("vfmsub231SD Scalar Register-Register Tests Completed\n\n");
}
...
static void test_scalar_reg_mem_operand() {
    ...
    printf("vfmsub231SD Scalar Register-Memory Tests Completed\n\n");
}
...
int main() {
    ...
    printf("vfmsub231SD normal values tests completed.\n");
