...
static void test_256bit_reg_reg_operand() {
    ...
    printf("vfmaddsub132PD 256-bit Register-Register Tests Completed\n\n");
}
...
static void test_128bit_reg_reg_operand() {
    ...
    printf("vfmaddsub132PD 128-bit Register-Register Tests Completed\n\n");
}
...
static void test_256bit_reg_mem_operand() {
    ...
    printf("vfmaddsub132PD 256-bit Register-Memory Tests Completed\n\n");
}
...
static void test_128bit_reg_mem_operand() {
    ...
    printf("vfmaddsub132PD 128-bit Register-Memory Tests Completed\n\n");
}
...
int main() {
    ...
    printf("vfmaddsub132PD normal values tests completed.\n");
