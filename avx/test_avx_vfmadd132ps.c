...
test_case_256 cases_256[TEST_CASE_COUNT] = {
    ...
    // 无穷大
    {
        {INFINITY, -INFINITY, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f},
        {1.0f, 1.0f, INFINITY, -INFINITY, 1.0f, 1.0f, 1.0f, 1.0f},
        {1.0f, 1.0f, 1.0f, 1.0f, INFINITY, -INFINITY, 1.0f, 1.0f},
        "Infinity values (256-bit)"
    },
    // NaN
    {
        {NAN, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f},
        {1.0f, NAN, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f},
        {1.0f, 2.0f, NAN, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f},
        "NaN values (256-bit)"
    },
    // 边界值
    {
    ...
    // 混合值
    {
        {1.0f, INFINITY, NAN, 0.0f, -INFINITY, -0.0f, 2.0f, 3.0f},
        {INFINITY, NAN, 0.0f, NAN, 1.0f, 2.0f, 3.0f, 4.0f},
        {NAN, 0.0f, INFINITY, 1.0f, 2.0f, 3.0f, 4.0f, 5.0f},
...
static void test_256bit_reg_reg_operand() {
    ...
    printf("VFMADD132PS 256-bit Register-Register Tests Completed\n\n");
}
...
static void test_128bit_reg_reg_operand() {
    ...
    printf("VFMADD132PS 128-bit Register-Register Tests Completed\n\n");
}
...
static void test_256bit_reg_mem_operand() {
    ...
    printf("VFMADD132PS 256-bit Register-Memory Tests Completed\n\n");
}
...
static void test_128bit_reg_mem_operand() {
    ...
    printf("VFMADD132PS 128-bit Register-Memory Tests Completed\n\n");
}
...
int main() {
    ...
    printf("All VFMADD132PS tests completed. Results are for verification on physical CPU vs box64.\n");
