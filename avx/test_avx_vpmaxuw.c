...
// VPMAXUW测试函数
int test_vpmaxuw() {
    printf("Testing VPMAXUW instruction\n");
    printf("==========================\n");
    ...
    // 测试1: 128位基本功能测试
    {
        ...
        // 测试数据包含边界值和常规值
        uint16_t src1[8] = {65535, 0, 10000, 20000, 30000, 40000, 50000, 60000};
        uint16_t src2[8] = {0, 65535, 40000, 30000, 20000, 10000, 60000, 50000};
        uint16_t dst[8] = {0};

        // 预期结果
        uint16_t expected[8] = {
            65535, 65535, 40000, 30000, 30000, 40000, 60000, 60000
        };
    ...
    // 测试2: 128位内存操作数测试
    {
        ...
        // 寄存器操作数
        uint16_t src1[8] = {50000, 10000, 60000, 20000, 40000, 30000, 55000, 15000};
        
        // 内存操作数
        uint16_t src2_mem[8] = {
            45000, 15000, 55000, 25000, 35000, 45000, 50000, 10000
        };
        uint16_t dst[8] = {0};

        // 预期结果
        uint16_t expected[8] = {
            50000, 15000, 60000, 25000, 40000, 45000, 55000, 15000
        };
