...
// vfnmsub231pd指令测试
void test_vfnmsub231pd() {
    printf("--- Testing vfnmsub231pd (Fused Negative Multiply-Subtract of Packed Double-Precision Floating-Point Values) ---\n");
