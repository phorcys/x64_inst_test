...
// vfnmsub231ps指令测试
void test_vfnmsub231ps() {
    printf("--- Testing vfnmsub231ps (Fused Negative Multiply-Subtract of Packed Single-Precision Floating-Point Values) ---\n");
