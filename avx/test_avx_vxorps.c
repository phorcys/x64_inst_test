...
static void test_vxorps() {
    printf("--- Testing vxorps (bitwise XOR of packed single-precision) ---\n");
    int total_tests = 0;
    int passed_tests = 0;
    ...
    uint32_t expected_bits[8] = {
        ...
        0xECE8ECE0, 0xECE8ECE0,  // 修正位置3的预期值
        0x44444444, 0x88888888,
        0xCCCCCCCC, 0x44444444
    };
    ...
    uint32_t boundary_expected_bits[8] = {
        ...
        0xC07FFFFF, // 1.0f ^ 0xFFFFFFFF = 0xC07FFFFF
        0x40000000, // 2.0f ^ 0.0f = 2.0f
        0x15155555, // 3.0f ^ 0x55555555 = 0x15155555
        0xEA2AAAAA  // 修正位置7的预期值：4.0f ^ 0xAAAAAAAA = 0xEA2AAAAA
    };
    ...
    if (passed_tests == total_tests) {
        printf("All vxorps tests passed!\n");
    } else {
        printf("Some vxorps tests failed\n");
    }
}
