...
static void test_scalar_reg_reg_operand() {
    ...
    printf("vfnmsub231SD Scalar Register-Register Tests Completed\n\n");
}
...
static void test_scalar_reg_mem_operand() {
    ...
    printf("vfnmsub231SD Scalar Register-Memory Tests Completed\n\n");
}
...
int main() {
    ...
    printf("vfnmsub231SD normal values tests completed.\n");
