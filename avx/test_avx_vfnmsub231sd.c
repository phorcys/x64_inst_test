...
static void test_reg_reg_operand() {
    ...
    printf("VFNMSUB231SD Register-Register Tests Completed\n\n");
}
...
static void test_reg_mem_operand() {
    ...
    printf("VFNMSUB231SD Register-Memory Tests Completed\n\n");
}

int main() {
    printf("==================================\n");
    printf("VFNMSUB231SD Comprehensive Tests\n");
    printf("==================================\n\n");
    ...
    printf("All VFNMSUB231SD tests completed. Results are for verification on physical CPU vs box64.\n");
