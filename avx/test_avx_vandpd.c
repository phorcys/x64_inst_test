...
static void test_vandpd() {
    printf("--- Testing vandpd (packed double-precision bitwise AND) ---\n");
    int total_tests = 0;
    int passed_tests = 0;
    
    // 256-bit register-register test
    printf("Test 1: 256-bit register-register\n");
    uint64_t src1_u64[4] ALIGNED(32) = {
        0xFFFFFFFFFFFFFFFF, 0x0000000000000000, 
        0xAAAAAAAAAAAAAAAA, 0x5555555555555555
    };
    uint64_t src2_u64[4] ALIGNED(32) = {
        0xAAAAAAAAAAAAAAAA, 0x5555555555555555, 
        0xFFFFFFFFFFFFFFFF, 0x0000000000000000
    };
    ...
    print_int64_vec("Expected", (int64_t*)expected, 4);
    print_int64_vec("Result", (int64_t*)result, 4);
    ...
    uint64_t src1_128_u64[2] ALIGNED(16) = {
        0x1111111111111111, 0x2222222222222222
    };
    uint64_t src2_128_u64[2] ALIGNED(16) = {
    ...
    print_int64_vec("Expected", (int64_t*)expected_128, 2);
    print_int64_vec("Result", (int64_t*)result_128, 2);
    ...
    if (passed_tests == total_tests) {
        printf("All vandpd tests passed!\n");
    } else {
        printf("Some vandpd tests failed\n");
    }
}
