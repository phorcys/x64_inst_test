...
// Computes approximate reciprocals (1/x) of packed single-precision floating-point values

static void test_vrcpps() {
    printf("Testing VRCPPS\n");
    
    // 测试128位和256位版本
    float input128[4] = {1.0f, 2.0f, 4.0f, 8.0f};
    float expected128[4] = {1.0f/1.0f, 1.0f/2.0f, 1.0f/4.0f, 1.0f/8.0f};
    float result128[4] = {0};
    
    float input256[8] = {1.0f, 2.0f, 4.0f, 8.0f, 0.5f, -0.5f, INFINITY, NAN};
    float expected256[8] = {1.0f/1.0f, 1.0f/2.0f, 1.0f/4.0f, 1.0f/8.0f, 
                          1.0f/0.5f, 1.0f/-0.5f, 0.0f, NAN};
    float result256[8] = {0};

    // 测试128位版本
    printf("Testing VRCPPS (128-bit)\n");
