...
// vfnmadd231ss指令测试
void test_vfnmadd231ss() {
    printf("--- Testing vfnmadd231ss (Fused Negative Multiply-Add of Scalar Single-Precision Floating-Point Values) ---\n");
