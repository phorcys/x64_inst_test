...
static void test_reg_reg_operand() {
    ...
    printf("VFNMADD231SS Register-Register Tests Completed\n\n");
}
...
static void test_reg_mem_operand() {
    ...
    printf("VFNMADD231SS Register-Memory Tests Completed\n\n");
}

int main() {
    printf("==================================\n");
    printf("VFNMADD231SS Comprehensive Tests\n");
    printf("==================================\n\n");
    ...
    printf("All VFNMADD231SS tests completed. Results are for verification on physical CPU vs box64.\n");
