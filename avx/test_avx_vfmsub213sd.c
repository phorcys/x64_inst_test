...
static void test_scalar_reg_reg_operand() {
    ...
    printf("vfmsub213SD Scalar Register-Register Tests Completed\n\n");
}
...
static void test_scalar_reg_mem_operand() {
    ...
    printf("vfmsub213SD Scalar Register-Memory Tests Completed\n\n");
}

int main() {
    printf("==================================\n");
    printf("vfmsub213SD Comprehensive Tests\n");
    printf("==================================\n\n");
    
    test_scalar_reg_reg_operand();
    test_scalar_reg_mem_operand();
    
    printf("vfmsub213SD normal values tests completed.\n");
