...
// vfmaddsub213pd指令测试
void test_vfmaddsub213pd() {
    printf("--- Testing vfmaddsub213pd (Fused Multiply-Alternating Add/Subtract of Packed Double-Precision Floating-Point Values) ---\n");
